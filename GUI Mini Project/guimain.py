...
# Calculate the path to the root directory (GUI Mini Project)
root_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))

# Add the root directory to sys.path
sys.path.append(root_dir)

# Now you can import from Roles/admin.py
from utils.admin import login_for_all
from utils.user import open_login_sigup_page
